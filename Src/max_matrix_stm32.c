...
uint8_t CH[] = {
  ...
  6, 0x78, 0x08, 0x08, 0x2a, 0x1c, 0x08, 0,  // 26 - 'Right Arrow'
  6, 0x08, 0x1c, 0x2a, 0x08, 0x08, 0x78, 0,  // 27 - 'Left Arrow'
...
void shiftleft(void)
{
	int last = max_num*8-1;
	uint8_t old = buffer_row[last];
	int i;
	for (i=0; i<max_num*8; i++)
	{
